...
G_EMUL=m88kelfnbsd
G_EMULATION_OFILES=em88kelfnbsd.o em88kelf.o em88kbcs.o
...
G_OFILES=ldgram.o ldlex.o lexsup.o ldlang.o mri.o ldctor.o ldmain.o  ldwrite.o ldexp.o  ldemul.o ldver.o ldmisc.o  ldfile.o ldcref.o em88kelfnbsd.o em88kelf.o em88kbcs.o 
G_STRINGIFY=astring.sed
G_TEXINFOS=ld.texinfo
G_target_alias=m88k--netbsdelf
